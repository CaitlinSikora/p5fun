...
function Point(){
  ...
  this.stats = function(posX,posY){
    ...
    if(this.posX > 1000 || this.posY > 700 || this.pposX > 700 || this.pposY > 700|| this.velX > 50 || this.velY > 50|| this.accelX > 10 || this.accelY > 10|| this.jerk > 10){
      ...
      triangle(this.posX-(2+2.5*this.jerkX),this.posY-(2+2.5*this.jerkY),this.posX+(2+2.5*this.jerkX),this.posY+(2+2.5*this.jerkY),this.posX+20*this.jerkX,this.posY+20*this.jerkY);
      
      //strokeWeight(2+2*this.accel);
      fill(5*RR,6*GG,6*BB);
      //line(this.posX,this.posY,this.posX+20*this.accelX,this.posY+20*this.accelY);
      triangle(this.posX-(2+2.5*this.accelX),this.posY-(2+2.5*this.accelY),this.posX+(2+2.5*this.accelX),this.posY+(2+2.5*this.accelY),this.posX+20*this.accelX,this.posY+20*this.accelY);
      
      noStroke();
      //strokeWeight(2+3*this.vel);
      fill(3*RR,4*GG,5*BB);
      triangle(this.posX-(2+2.5*this.velX),this.posY-(2+2.5*this.velY),this.posX+(2+2.5*this.velX),this.posY+(2+2.5*this.velY),this.posX+20*this.velX,this.posY+20*this.velY);
